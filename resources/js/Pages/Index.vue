            ...
            <tbody>
              <tr v-for="task in tasks">
                ...
                <td >
                 ...
                 </td><td> <button @click.prevent="Filter(task.status)" class="btn btn-outline-info">Filter</button>
 ...
 <div class="mt-4 text-center"> <!-- Center the pagination -->
    <ul class="pagination justify-content-center"> <!-- Center the pagination list -->
      <li class="page-item" :class="{ 'disabled': !pagination.prev_page_url }">
        <a
          class="page-link"
          @click.prevent="pagination.prev_page_url ? navigateToPage(pagination.current_page - 1) : null"
          href="#"
        >
          Previous
        </a>
      ...
      <li class="page-item" :class="{ 'disabled': !pagination.next_page_url }">
        <a
          class="page-link"
          @click.prevent="pagination.next_page_url ? navigateToPage(pagination.current_page + 1) : null"
          href="#"
        >
          Next
        </a>
