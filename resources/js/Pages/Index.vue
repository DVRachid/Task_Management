  ...
  <div>
    ...
    <header class="bg-white ">
      <div
        ...
        <h1 class="text-center text-3xl font-bold tracking-tight">Task Management</h1>
      ...
      <table class="table table-bordered table-hover ">
        ...
        <tbody>
          <tr v-for="task in tasks">
            ...
            <td> <button @click.prevent="Filter(task.status)" class="btn btn-outline-info ml-2">Filter</button></td>
            <td> <button @click.prevent="Destroy(task.id)" class="btn btn-outline-danger">Delete</button></td>
